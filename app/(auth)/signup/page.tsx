      ...
      <div className="relative z-10 w-full max-w-[440px]">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-500 font-medium">Join 150+ clinics using Arcline AI.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#0066cc] transition-colors" size={18} />
                <input 
                  type="text"
                  required
                  value={name}
          ...
          <div className="mt-8 pt-8 border-t border-slate-100 text-center">
            <p className="text-sm text-slate-500 font-medium">
              ...
              <Link href="/login" className="text-[#0066cc] font-bold hover:underline">Log in</Link>
            </p>
          </div>
        </motion.div>
      </div>
